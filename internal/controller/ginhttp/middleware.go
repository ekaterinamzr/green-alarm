...
type middleware struct {
	parseToken func(context.Context, string) (id string, role int, err error)
}

func newMiddleware(parseToken func(context.Context, string) (id string, role int, err error)) *middleware {
