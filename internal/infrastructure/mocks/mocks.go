...
// GenerateToken mocks base method.
func (m *MockHasher) GenerateToken(ctx context.Context, id, role int) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateToken", ctx, id, role)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// GenerateToken indicates an expected call of GenerateToken.
func (mr *MockHasherMockRecorder) GenerateToken(ctx, id, role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateToken", reflect.TypeOf((*MockHasher)(nil).GenerateToken), ctx, id, role)
}

// ParseToken mocks base method.
func (m *MockHasher) ParseToken(arg0 context.Context, arg1 string) (int, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseToken", arg0, arg1)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(int)
...
// ParseToken indicates an expected call of ParseToken.
func (mr *MockHasherMockRecorder) ParseToken(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseToken", reflect.TypeOf((*MockHasher)(nil).ParseToken), arg0, arg1)
}
